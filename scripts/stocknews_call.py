...
def get_stocknews_data():
    # doc = vanity.get_jsonparsed_data("https://stocknewsapi.com/api/v1?tickers=DBSDY,UOVEY,SINGY,SE&items=50&token=cdxgrhebia7lvobqdvhfbhhk0wahvwlyo2e9kkmj")['data']
